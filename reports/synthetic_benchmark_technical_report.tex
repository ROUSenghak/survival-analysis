...
\texttt{true relations} & Hidden evaluation labels, stored as \nolinkurl{true_relations.parquet}. This must be used only after algorithm outputs are produced. \\
...
\begin{quote}
The synthetic benchmark is credible enough to begin linkage-algorithm evaluation under controlled truth, but it does not replace inaccessible real renewal labels.
\end{quote}
